...
Generated on: 2025-04-16 09:39:07
"""
...
def query_find_stock_type_on_date(stock_code: str = '5', acdate: str = '2023-03-01') -> str:
    """
...
def query_search_date_stock_prediction(company_name: str = '中國銀行', acdate: str = '2023-03-01') -> str:
    """
    ...
    query = query.format(
        ...
        acdate=str(acdate) if acdate is not None else ""
    )
...
def query_get_highest_return_stocks(index_code: str = 'HSI', number: str = '5', acdate: str = '2023-03-01') -> str:
    """
    ...
    # Correct replacement using the actual parameter names in curly braces
    query = query.format(
        index_code=str(index_code) if index_code is not None else "", number=str(number) if number is not None else "",
        acdate=str(acdate) if acdate is not None else ""
    )
...
def query_get_stock_data_by_date_industry_rating(industry_code: str = 'BNK', index_code: str = 'HSI',
                                                 acdate: str = '2023-03-01') -> str:
    """
    ...
    # Correct replacement using the actual parameter names in curly braces
    query = query.format(
        industry_code=str(industry_code) if industry_code is not None else "",
...
def query_worse_stock_performance_on_date(index_code: str = 'HSI', acdate: str = '2023-03-01') -> str:
    """
...
def query_find_min_hk_pb_date(industry_code: str = 'BNK', acdate: str = '2023-03-01', number: str = '5') -> str:
    """
    ...
    query = query.format(
        industry_code=str(industry_code) if industry_code is not None else "",
        acdate=str(acdate) if acdate is not None else "", number=str(number) if number is not None else ""
    )
...
def query_get_board_weight_above_percent(index_code: str = 'HSI', acdate: str = '2023-03-01',
                                         weight: str = '10') -> str:
    """
...
def query_get_stock_price_range_change(start_date: str = '2023-01-01', end_date: str = '2023-03-31',
                                       index_code: str = 'HSI') -> str:
    """
    查詢xx時間段，xx指數的點數變化
    ...
    query = query.format(
        ...
        index_code=str(index_code) if index_code is not None else ""
    )
...
def query_get_report_rate_by_time_period_stock_number(start_date: str = '2023-01-01', end_date: str = '2023-03-31',
                                                      stock_code: str = '5') -> str:
    """
    查詢xx時間段，xx股票號的回報率
...
def query_get_turnover_history(start_date: str = '2023-01-01', end_date: str = '2023-03-31',
                               stock_code: str = '5') -> str:
    """
...
def query_get_highest_lowest_price_by_date_stock(stock_code: str = '5', acdate: str = '2023-03-01') -> str:
    """
...
class QueryGetHighestLowestPriceByDateStockTool(BaseTool):
    """
    查詢在xx日期，美股xxxx股票號的最高價、最低價及收市價
    ...
    name: str = "query_get_highest_lowest_price_by_date_stock_tool"
    description: str = "查詢在xx日期，美股xxxx股票號的最高價、最低價及收市價"

    def _run(self, stock_code: str = '5', acdate: str = '2023-03-01') -> str:
        return query_get_highest_lowest_price_by_date_stock(stock_code=stock_code, acdate=acdate)
...
class QueryFindStockTypeOnDateTool(BaseTool):
    """
    查詢在xx日期，某個xxxx股票號的技術形態
    ...
    name: str = "query_find_stock_type_on_date_tool"
    description: str = "查詢在xx日期，某個xxxx股票號的技術形態"

    def _run(self, stock_code: str = '5', acdate: str = '2023-03-01') -> str:
        return query_find_stock_type_on_date(stock_code=stock_code, acdate=acdate)
...
class QuerySearchDateStockPredictionTool(BaseTool):
    """
    查詢在xx日期，某個xx股票(公司名)的預測市盈率
    ...
    name: str = "query_search_date_stock_prediction_tool"
    description: str = "查詢在xx日期，某個xx股票(公司名)的預測市盈率"

    def _run(self, company_name: str = '中國銀行', acdate: str = '2023-03-01') -> str:
        return query_search_date_stock_prediction(company_name=company_name, acdate=acdate)
...
class QueryGetHighestReturnStocksTool(BaseTool):
    """
    查詢在xx日期，xx指數成分股預測收益率最高的n只股票
    ...
    name: str = "query_get_highest_return_stocks_tool"
    description: str = "查詢在xx日期，xx指數成分股預測收益率最高的n只股票"

    def _run(self, index_code: str = 'HSI', number: str = '5', acdate: str = '2023-03-01') -> str:
        return query_get_highest_return_stocks(index_code=index_code, number=number, acdate=acdate)
...
class QueryGetStockDataByDateIndustryRatingTool(BaseTool):
    """
    查詢在xx日期，xx行業在xx指數有多少隻股票，以及比重
    ...
    name: str = "query_get_stock_data_by_date_industry_rating_tool"
    ...
    def _run(self, industry_code: str = 'BNK', index_code: str = 'HSI', acdate: str = '2023-03-01') -> str:
        return query_get_stock_data_by_date_industry_rating(industry_code=industry_code, index_code=index_code,
                                                            acdate=acdate)
...
class QueryWorseStockPerformanceOnDateTool(BaseTool):
    """
    查詢在xx日期，xxx指數表現最差的股票
    ...
    name: str = "query_worse_stock_performance_on_date_tool"
    description: str = "查詢在xx日期，xxx指數表現最差的股票"

    def _run(self, index_code: str = 'HSI', acdate: str = '2023-03-01') -> str:
        return query_worse_stock_performance_on_date(index_code=index_code, acdate=acdate)
...
class QueryFindMinHkPbDateTool(BaseTool):
    """
    查詢xx日期，xx行業PB/ratio最低的n只香港股票
    ...
    name: str = "query_find_min_hk_pb_date_tool"
    description: str = "查詢xx日期，xx行業PB/ratio最低的n只香港股票"

    def _run(self, industry_code: str = 'BNK', acdate: str = '2023-03-01', number: str = '5') -> str:
        return query_find_min_hk_pb_date(industry_code=industry_code, acdate=acdate, number=number)
...
class QueryGetBoardWeightAbovePercentTool(BaseTool):
    """
    查詢xx日期，在xx指數中比重超過n%的板塊
    ...
    name: str = "query_get_board_weight_above_percent_tool"
    description: str = "查詢xx日期，在xx指數中比重超過n%的板塊"

    def _run(self, index_code: str = 'HSI', acdate: str = '2023-03-01', weight: str = '10') -> str:
        return query_get_board_weight_above_percent(index_code=index_code, acdate=acdate, weight=weight)
...
class QueryGetStockPriceRangeChangeTool(BaseTool):
    """
    查詢xx時間段，xx指數的點數變化
    ...
    name: str = "query_get_stock_price_range_change_tool"
    description: str = "查詢xx時間段，xx指數的點數變化"

    def _run(self, start_date: str = '2023-01-01', end_date: str = '2023-03-31', index_code: str = 'HSI') -> str:
        return query_get_stock_price_range_change(start_date=start_date, end_date=end_date, index_code=index_code)
...
class QueryGetReportRateByTimePeriodStockNumberTool(BaseTool):
    """
    查詢xx時間段，xx股票號的回報率
    ...
    name: str = "query_get_report_rate_by_time_period_stock_number_tool"
    description: str = "查詢xx時間段，xx股票號的回報率"

    def _run(self, start_date: str = '2023-01-01', end_date: str = '2023-03-31', stock_code: str = '5') -> str:
        return query_get_report_rate_by_time_period_stock_number(start_date=start_date, end_date=end_date,
...
class QueryGetTurnoverHistoryTool(BaseTool):
    """
    查詢xx時間段，xx股票的turnover
    ...
    name: str = "query_get_turnover_history_tool"
    description: str = "查詢xx時間段，xx股票的turnover"

    def _run(self, start_date: str = '2023-01-01', end_date: str = '2023-03-31', stock_code: str = '5') -> str:
        return query_get_turnover_history(start_date=start_date, end_date=end_date, stock_code=stock_code)
...
def get_financial_query_tools() -> List[BaseTool]:
    ...
    return [
        QueryGetHighestLowestPriceByDateStockTool(),
        QueryFindStockTypeOnDateTool(),
        QuerySearchDateStockPredictionTool(),
        QueryGetHighestReturnStocksTool(),
        QueryGetStockDataByDateIndustryRatingTool(),
        QueryWorseStockPerformanceOnDateTool(),
        QueryFindMinHkPbDateTool(),
        QueryGetBoardWeightAbovePercentTool(),
        QueryGetStockPriceRangeChangeTool(),
        QueryGetReportRateByTimePeriodStockNumberTool(),
        QueryGetTurnoverHistoryTool()
    ]
